...
var transact = require('./services/transact.js')
var purchase = require('./services/purchase.js')
...
handleTopicRequest("homeImg",Books)
handleTopicRequest("Transaction", transact)
